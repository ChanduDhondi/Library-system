...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var salt, adminPassword, userPassword, admin, user, author1, author2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.genSalt(10)];
                case 1:
                    salt = _a.sent();
                    return [4 /*yield*/, bcryptjs_1.default.hash("adminpass", salt)];
                case 2:
                    adminPassword = _a.sent();
                    return [4 /*yield*/, bcryptjs_1.default.hash("userpass", salt)];
                case 3:
                ...
                case 5:
                    user = _a.sent();
                    return [4 /*yield*/, prisma.author.upsert({
